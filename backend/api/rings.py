...
async def create_ring_case(ring_id: str) -> dict[str, Any]:
    ...
    case = {
        ...
        "checklist": [
            {"item_key": "IDENTITY_VERIFIED", "label": "Identity verified", "required": True, "status": "PENDING", "completed_by": None, "completed_at": None, "notes": None},
            {"item_key": "ENTITY_CONFIRMED", "label": "Entity confirmed", "required": True, "status": "PENDING", "completed_by": None, "completed_at": None, "notes": None},
            {"item_key": "BANK_CONFIRMED", "label": "Bank account confirmed", "required": True, "status": "PENDING", "completed_by": None, "completed_at": None, "notes": None},
            {"item_key": "PAYROLL_REVIEWED", "label": "Payroll reviewed", "required": True, "status": "PENDING", "completed_by": None, "completed_at": None, "notes": None},
            {"item_key": "EXPOSURE_CONFIRMED", "label": "Exposure confirmed", "required": True, "status": "PENDING", "completed_by": None, "completed_at": None, "notes": None},
            {"item_key": "GRAPH_COMPLETE", "label": "Graph analysis complete", "required": True, "status": "PENDING", "completed_by": None, "completed_at": None, "notes": None},
            {"item_key": "RING_MEMBERS_ID", "label": "Ring members identified", "required": True, "status": "PENDING", "completed_by": None, "completed_at": None, "notes": None},
        ],
        "reviewer": None,
        "review_status": "NONE",
        "review_notes": None,
